# H2 Run Plan: Claude Code + Opus (Native Skill)

## Phase 1: Setup

- [ ] Task: Confirm all cases available in evaluation/datasets/
- [ ] Task: Confirm rubric finalized (eval-pilot-calibration complete)
- [ ] Task: Switch Claude Code model to claude-opus-4-6 and verify

## Phase 2: Run All Cases (3 runs each)

- [ ] Task: case-01, run-1 — Claude Code + Opus, SKILL.md loaded natively, Prompt S, temp=0, new session
    - [ ] Save raw-transcript.md with metadata (confirm model = claude-opus-4-6)
...
- [ ] Task: Verify model version in all metadata headers = claude-opus-4-6
