...
| [06 Multimodal capability fabric](./archive/multimodal-capability-fabric_20260731/index.md) | [#11](https://github.com/edithatogo/rcagent/issues/11) | B | 02, 03 | Completed contract fabric; unsupported runtime combinations remain disabled |
| [07 Retrieval and knowledge system](./tracks/retrieval-knowledge-system_20260731/index.md) | [#12](https://github.com/edithatogo/rcagent/issues/12) | B | 02, 03, 04 | Deterministic lexical retrieval; vector, hybrid, reranking and external-provider profiles explicitly unsupported |
