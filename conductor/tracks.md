...
|---|---|---:|---|
| [x] | [00 Agent Skills Living Conformance and Portable Architecture](./archive/agent-skills-living-conformance_20260731/index.md) | [#5](https://github.com/edithatogo/rcagent/issues/5) | Reviewed and archived; bounded Codex and AGY actual-client evidence passed; unavailable clients remain unverified |
| [x] | [01 Safety Systems Foundation and Solo-Developer Harness](./archive/safety-systems-foundation_20260731/index.md) | [#6](https://github.com/edithatogo/rcagent/issues/6) | Reviewed and archived; 00 remains phase-only for licence/release scope |
